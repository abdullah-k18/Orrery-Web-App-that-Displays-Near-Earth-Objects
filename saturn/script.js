...
const saturn = createTexturedPlanet(3, saturnTexture, 0);
scene.add(saturn);

function createFlatRing(innerRadius, outerRadius, texture) {
...
const saturnRing = createFlatRing(3.5, 4.5, ringTexture);
saturnRing.rotation.x = Math.PI / 2;
saturnRing.rotation.y = Math.PI / 50;
